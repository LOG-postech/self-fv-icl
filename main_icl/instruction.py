shared_zero_prompt = '''The following is a multiple-choice question with potential answers. Please make your best effort and select the correct answer. You only need to output the option.\n\n'''
...
shared_few_prompt = '''Below are some examples of multiple-choice questions with potential answers.\n\n'''
...
base_cot_prompt = '''Please reason step-by-step and select the correct answer. You only need to output the answer.\n\n'''

shared_cot_prompt = '''The following is a multiple-choice question with potential answers. Please reason step-by-step and select the correct answer. You only need to output the option.\n\n'''
